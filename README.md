...
<body class="bg-white text-gray-800">
    ...
    <script>
        ...
        const translations = {
            ...
            servicesTitle: {
             ...
             servicesSubTitle: {
                 ...
                 sv: "Vi erbjuder en omfattande uppsättning IT-tjänster utformade för att driva ditt företag framåt digitalt och säkerställa dess säkerhet.",
                 zh: "我们提供全面的 IT 服务套件，旨在推动您的业务数字化发展并确保其安全。",
                 ar: "نحن نقدم مجموعة شاملة من خدمات تكنولوجيا المعلومات المصممة لدفع أعمالك إلى الأمام رقميًا وضمان أمنها."
             },
             service1Title: { en: "Digital Marketing", sv: "Digital Marknadsföring", zh: "数字营销", ar: "التسويق الرقمي" },
             service1Desc: { en: "Crafting tailored digital marketing plans to reach your target audience, build brand awareness, and drive conversions across various online channels.", sv: "Skapar skräddarsydda digitala marknadsföringsplaner för att nå din målgrupp, bygga varumärkesmedvetenhet och driva konverteringar över olika onlinekanaler.", zh: "制定量身定制的数字营销计划，以接触目标受众、建立品牌知名度并通过各种在线渠道推动转化。", ar: "صياغة خطط تسويق رقمي مخصصة للوصول إلى جمهورك المستهدف، وبناء الوعي بالعلامة التجارية، وزيادة التحويلات عبر مختلف القنوات عبر الإنترنت." },
             service2Title: { en: "Search Engine Optimization (SEO)", sv: "Sökmotoroptimering (SEO)", zh: "搜索引擎优化 (SEO)", ar: "تحسين محركات البحث (SEO)" },
             service2Desc: { en: "Optimizing your website and online content to rank higher in search engine results, increasing organic traffic and visibility.", sv: "Optimerar din webbplats och onlineinnehåll för att rankas högre i sökmotorresultaten, vilket ökar organisk trafik och synlighet.", zh: "优化您的网站和在线内容以在搜索引擎结果中排名更高，从而增加自然流量和可见性。", ar: "تحسين موقع الويب الخاص بك والمحتوى عبر الإنترنت للحصول على مرتبة أعلى في نتائج محركات البحث، وزيادة حركة المرور العضوية والرؤية." },
             service3Title: { en: "Cybersecurity Solutions", sv: "Cybersäkerhetslösningar", zh: "网络安全解决方案", ar: "حلول الأمن السيبراني" },
             service3Desc: { en: "Protecting your business from digital threats with robust security measures, risk assessments, and proactive defense strategies.", sv: "Skyddar ditt företag från digitala hot med robusta säkerhetsåtgärder, riskbedömningar och proaktiva försvarsstrategier.", zh: "通过强大的安全措施、风险评估和主动防御策略，保护您的业务免受数字威胁。", ar: "حماية عملك من التهديدات الرقمية من خلال تدابير أمنية قوية وتقييمات للمخاطر واستراتيجيات دفاعية استباقية." },
            portfolioTitle: { en: "Portfolio & Case Studies", sv: "Portfölj & Fallstudier", zh: "作品集与案例研究", ar: "أعمالنا ودراسات الحالة" },
            portfolioSubTitle: { en: "Discover how we've helped businesses achieve significant digital growth and enhance their security posture.", sv: "Upptäck hur vi har hjälpt företag att uppnå betydande digital tillväxt och förbättra sin säkerhetsposition.", zh: "了解我们如何帮助企业实现显著的数字增长并增强其安全态势。", ar: "اكتشف كيف ساعدنا الشركات على تحقيق نمو رقمي كبير وتعزيز وضعها الأمني." },
            blogTitle: { en: "Blog & Insights", sv: "Blogg & Insikter", zh: "博客与见解", ar: "المدونة والرؤى" },
            blogSubTitle: { en: "Stay updated with the latest trends, tips, and strategies in digital marketing, SEO, and cybersecurity.", sv: "Håll dig uppdaterad med de senaste trenderna, tipsen och strategierna inom digital marknadsföring, SEO och cybersäkerhet.", zh: "随时了解数字营销、搜索引擎优化和网络安全领域的最新趋势、技巧和策略。", ar: "ابق على اطلاع بأحدث الاتجاهات والنصائح والاستراتيجيات في التسويق الرقمي وتحسين محركات البحث والأمن السيبراني." },
            blogViewAll: { en: "View All Posts", sv: "Visa Alla Inlägg", zh: "查看所有帖子", ar: "عرض كل المشاركات" },
            contactTitle: { en: "Contact Us", sv: "Kontakta Oss", zh: "联系我们", ar: "اتصل بنا" },
            contactSubTitle: { en: "Ready to secure your digital growth? Get in touch with us for a consultation.", sv: "Redo att säkra din digitala tillväxt? Kontakta oss för en konsultation.", zh: "准备好保障您的数字增长了吗？联系我们进行咨询。", ar: "هل أنت مستعد لتأمين نموك الرقمي؟ تواصل معنا للحصول على استشارة." },
            contactInfoTitle: { en: "Our Information", sv: "Vår Information", zh: "我们的信息", ar: "معلوماتنا" },
            contactAddrLabel: { en: "Address:", sv: "Adress:", zh: "地址:", ar: "العنوان:" },
            contactPhoneLabel: { en: "Phone:", sv: "Telefon:", zh: "电话:", ar: "الهاتف:" },
            contactEmailLabel: { en: "Email:", sv: "E-post:", zh: "电子邮件:", ar: "البريد الإلكتروني:" },
            contactFormTitle: { en: "Send Us a Message", sv: "Skicka Oss ett Meddelande", zh: "给我们留言", ar: "أرسل لنا رسالة" },
            contactFormName: { en: "Name:", sv: "Namn:", zh: "姓名:", ar: "الاسم:" },
            contactFormEmail: { en: "Email:", sv: "E-post:", zh: "电子邮件:", ar: "البريد الإلكتروني:" },
            contactFormSubject: { en: "Subject:", sv: "Ämne:", zh: "主题:", ar: "الموضوع:" },
            contactFormMessage: { en: "Message:", sv: "Meddelande:", zh: "信息:", ar: "الرسالة:" },
            contactFormSend: { en: "Send Message", sv: "Skicka Meddelande", zh: "发送信息", ar: "إرسال الرسالة" },
            footerSlogan: { en: "Securing your digital future.", sv: "Säkrar din digitala framtid.", zh: "保障您的数字未来。", ar: "تأمين مستقبلك الرقمي." },
            footerLinksTitle: { en: "Quick Links", sv: "Snabblänkar", zh: "快速链接", ar: "روابط سريعة" },
            footerHome: { en: "Home", sv: "Hem", zh: "首页", ar: "الرئيسية" },
            footerAbout: { en: "About Us", sv: "Om Oss", zh: "关于我们", ar: "من نحن" },
            footerServices: { en: "Services", sv: "Tjänster", zh: "服务", ar: "خدماتنا" },
            footerPortfolio: { en: "Portfolio", sv: "Portfölj", zh: "作品集", ar: "أعمالنا" },
            footerBlog: { en: "Blog", sv: "Blogg", zh: "博客", ar: "المدونة" },
            footerContact: { en: "Contact", sv: "Kontakt", zh: "联系", ar: "اتصل بنا" },
            footerContactTitle: { en: "Contact Info", sv: "Kontaktinfo", zh: "联系信息", ar: "معلومات الاتصال" },
            footerSocialTitle: { en: "Follow Us", sv: "Följ Oss", zh: "关注我们", ar: "تابعنا" },
            footerCopyright: { en: "© 2025 KazTech. All rights reserved.", sv: "© 2025 KazTech. Alla rättigheter förbehållna.", zh: "© 2025 KazTech. 版权所有。", ar: "© 2025 كازتيك. جميع الحقوق محفوظة." }
        ...
        const mobileNavLinks = mobileMenu.querySelectorAll('a[href^="#"]'); // Links inside mobile menu
        ...
        mobileNavLinks.forEach(link => {
            link.addEventListener('click', () => {
                ...
                const icon = menuButton.querySelector('svg path');
                icon.setAttribute('d', 'M4 6h16M4 12h16m-7 6h7'); // Reset icon
            });
        });

        // --- Language Switching Logic ---
        const htmlTag = document.getElementById('html-tag');
        const langSwitchers = document.querySelectorAll('.language-switcher'); // Get both desktop and mobile switchers
        ...
        function switchLanguage(lang) {
            ...
            translatableElements.forEach(el => {
                ...
                if (translations[key] && translations[key][lang]) {
                    // Use innerText for most elements, but check for specific tags like <title>
                    if (el.tagName === 'TITLE') {
        ...
        // Add event listeners to all language links
        langSwitchers.forEach(switcher => {
            switcher.querySelectorAll('a').forEach(link => {
                link.addEventListener('click', (e) => {
                    ...
                    // If mobile menu is open, close it after language selection
                    if (!mobileMenu.classList.contains('hidden')) {
                         mobileMenu.classList.add('hidden');
                         const icon = menuButton.querySelector('svg path');
                         icon.setAttribute('d', 'M4 6h16M4 12h16m-7 6h7'); // Reset icon
        ...
        // --- Initial Setup ---
        // Set initial language on page load (e.g., based on browser settings or default)
        document.addEventListener('DOMContentLoaded', () => {
            // You could try to detect browser language here, otherwise default to 'en'
            const initialLang = 'en'; // Default language
